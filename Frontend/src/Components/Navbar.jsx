                        ...
                        <div className="max-w-screen-xl flex shadow-2xl bg-white rounded-3xl flex-wrap items-center justify-between mx-auto mt-8 p-2">
                            ...
                            <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
                                <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
                                    <li>
                                        <a href="#" className="block py-2 px-3 cursor-pointer  text-[#766f6f] rounded-sm focus:text-[#8a3ab9]" aria-current="page">Home</a>
                                    </li>
                                    <li>
                                        <a href="#" className="block py-2 px-3 cursor-pointer text-[#766f6f] rounded-sm focus:text-[#8a3ab9] ">Contribute</a>
                                    </li>
                                    <li>
                                        <a href="#" className="block py-2 px-3 cursor-pointer text-[#766f6f] rounded-sm focus:text-[#8a3ab9] ">Services</a>
                                    </li>
                                    <li>
                                        <a href="#" className="block py-2 px-3 cursor-pointer text-[#766f6f] rounded-sm  focus:text-[#8a3ab9]">Pricing</a>
                                    </li>
                                    <li>
                                        <a href="#" className="block py-2 px-3  cursor-pointer text-[#766f6f] rounded-sm focus:text-[#8a3ab9]">Contact</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
